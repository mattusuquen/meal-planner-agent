...
export default function MobileNav({ onChatOpen }: MobileNavProps) {
  ...
  return (
    <nav className="flex md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 pb-safe">
      <div className="flex w-full">
        ...
        <button
          onClick={onChatOpen}
          className="flex-1 flex flex-col items-center justify-center py-2 gap-0.5 transition-colors text-gray-400 hover:text-brand-600"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
